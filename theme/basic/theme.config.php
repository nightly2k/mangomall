...
if(! defined('G5_THEME_DEVICE')) define('G5_THEME_DEVICE', 'mobile'); // SHH pc 버전 제거 (24.11.08)
...
if(! defined('G5_COMMUNITY_USE')) define('G5_COMMUNITY_USE', false); // SHH 커뮤니티 제거 (24.11.07)
