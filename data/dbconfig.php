...
define('G5_MYSQL_USER', 'nightly2');
define('G5_MYSQL_PASSWORD', 'tkrtmfdl2!');
define('G5_MYSQL_DB', 'nightly2');
define('G5_MYSQL_SET_MODE', true);

define('G5_TABLE_PREFIX', 'g5_');

define('G5_TOKEN_ENCRYPTION_KEY', '9b8c0a53094a604511f4b0b75fdde186'); // 토큰 암호화에 사용할 키
